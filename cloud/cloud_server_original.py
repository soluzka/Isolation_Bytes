...
curl -L "$BASE_URL/download/IsolationBytes-v1.8.953.0.apk" -o /tmp/IsolationBytes-v1.8.953.0.apk
if command -v adb &>/dev/null; then
    echo "Installing via adb..."
    adb install -r /tmp/IsolationBytes-v1.8.953.0.apk
else
    echo "adb not found. APK saved to /tmp/IsolationBytes-v1.8.953.0.apk"
