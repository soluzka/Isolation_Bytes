...
def _generate_antivirus_server_spec(spec_path):
    ...
    hidden = ['flask','flask.sessions','flask_cors','flask_limiter','flask_wtf','werkzeug','requests','psutil','ssl','dotenv','cryptography','cryptography.fernet','bcrypt','pyotp','security.yara_scanner','security.ml_yara_analyzer','security.c2_detector','security.secure_memory','security.local_assistant','security.assistant_trainer','security.assistant_database','security.local_agent','quarantine_utils','file_crypto','utils.paths','waitress','sklearn','sklearn.ensemble','sklearn.linear_model','sklearn.svm','sklearn.tree','sklearn.neural_network','sklearn.preprocessing','sklearn.decomposition','sklearn.pipeline','sklearn.metrics','sklearn.model_selection','numpy','scipy','scipy.sparse','onnxruntime','yara','joblib','pefile','tlsh','lief']
