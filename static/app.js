...
function showAgentInstallPrompt() {
    ...
    if (info.cmd) {
        ...
        cmdDiv.innerHTML = '<span style="font-size:0.8em;color:#778da9">' + info.cmdLabel + '</span><br><code style="background:#1a2a3a;color:#90e0ef;padding:4px 8px;border-radius:4px;font-size:0.85em;display:inline-block;margin-top:4px;user-select:all">' + info.cmd + '</code>';
